function [f_obj] = batchFunction(parameters,plotOn) 
% calclates the objective function of a set of parameters by comparing 
% the model output to experimental data
%% Inputs %%
% parameters = 47x1 vector of kinetic parameters
% plotOn = binary to determine if the output is plotted 1 = true

%% Ouputs %%
% f_obj = some measure of the error of the fit, should be minimizes
%% Extra Inputs %%
