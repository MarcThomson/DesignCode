...
c_ASP_int_0     =    0;    %  mM  =  9
c_ATP_0         =    0;    %  mM  = 10
c_BIOM_ext_0    =   184.8000;    %  mM  =  11 RELATED TO VCD % 5.4*2.3 is probably what to use
c_BIOM_int_0    = 0;    %  mM  =  12
c_C_C_ext_0     = 1.5;    %  mM  =  13
c_C_C_int_0     =    0;    %  mM  =  14
c_CO2_ext_0     =    0;    %  mM  =  15
c_CO2_int_0     =    0;    %  mM  =  16
c_CYS_0         =    0;    %  mM  =  17
...
c_NH3_ext_0     =   0;    %  mM  =  32
c_NH3_int_0     =    0;    %  mM  =  33
c_O2_ext_0      =    0.1666;    %  mM  =  34
c_O2_int_0      =    0;    %  mM  =  35
c_OXA_0         =    0;    %  mM  =  36
c_PYR_0         =    0;    %  mM  =  37
c_SER_ext_0     =  11;    %  mM  =  38
c_SER_int_0     =   0;    %  mM  =  39
shift_0         =   0;    %    
R_0             =   5.8;    %units

initialConditionsCryo_vec = [c_AKG_0, c_ALA_ext_0, c_ALA_int_0, c_ANTI_ext_0,...
