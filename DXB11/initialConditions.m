...
c_NH4_0     = 2.00E-01; % mM
c_O2_0      = 0.1;      % mmol/(10^6 cell)             %total guess for now
...
c_TYR_0     = 1.3;      % mM
c_VAL_0     = 7.00E-01; % mM
c_X5P_0     = 1.5E-7;   % mmol/(10^6 cell) 
c_Cell_0    = 0.3;      % 10^6 cells/mL


y0 = ...
    [c_ACCOA_0, c_ADP_0, c_AKG_0, c_ALA_0, c_AMP_0, c_ARG_0, c_ASN_0,...
    c_ASP_0,c_ATP_0, c_CIT_0, c_CYS_0, c_EGLC_0, c_EGLN_0, c_EGLU_0,...
    c_F6P_0,c_G6P_0,c_GAP_0, c_GLU_0, c_GLY_0, c_HIS_0, c_ILE_0,...
    c_LAC_0, c_LEU_0, c_LYS_0,c_mAb_0,c_MAL_0, c_MET_0, c_NAD_0,...
    c_NADH_0, c_NADP_0, c_NADPH_0, c_NH4_0, c_O2_0, c_OXA_0, c_PEP_0,...
    c_PHE_0, c_PRO_0, c_PYR_0, c_R5P_0, c_SER_0, c_SUC_0, c_THR_0,...
    c_TYR_0, c_VAL_0, c_X5P_0, c_Cell_0];
