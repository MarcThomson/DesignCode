...
for i = 1:length(t)-1
   ...
   [K1, R1,~,~,~] =  instantRatesV2(C(1:end-1,i),t,Perfusion,cellType, shift, R(i));
   ...
   try
   [K2, R2,~,~,~] = instantRatesV2(C(1:end-1,i)+K1(1:end-1)/2, t + h/2 ,Perfusion,cellType, shift, R1);
   ...
   [K3, R3,~,~,~] = instantRatesV2(C(1:end-1,i)+K2(1:end-1)/2, t + h/2 ,Perfusion,cellType, shift, R2);
   ...
   [K4, R4,~,~,~] = instantRatesV2(C(1:end-1,i)+K3(1:end-1), t + h ,Perfusion,cellType, shift, R3);
   ...
   [~, R(i+1),v(:,i+1),objVec(i+1),exitVec(i+1)] =...
       instantRatesV2(C(1:end-1,i+1), t + h ,Perfusion,cellType, shift, Rtest);
